...
if __name__ == '__main__':
    DATASET = 'imagenet'
    MODEL_NAME = 'vit_b_32'
    GENERATORS = ['_random','_captum'] # Empty means random. Another alternative is '_full', that generates all possible rankings , '_genetic'
    ...
    for DATASET, MODEL_NAME, GENERATORS, CHUNKINESS in tuples_to_test:
        ...
        for generator_name in GENERATORS:
            ...
            for sample_index in SAMPLE_INDICES:
                ...
                all_measures = compute_measures_for_sample(network, row, label, masking_values, NUM_RANKINGS, num_samples, generator_name, genetic_iterations=GENETIC_ITERATIONS, chunkiness=CHUNKINESS)
